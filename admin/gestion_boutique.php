...
{   // debug($_POST);
    ...
    executeRequete("INSERT INTO produit (id_produit, reference, categorie, titre, description, photo, prix, stock) values ('', '$_POST[reference]', '$_POST[categorie]', '$_POST[titre]', '$_POST[description]', '$photo_bdd',  '$_POST[prix]',  '$_POST[stock]')");
