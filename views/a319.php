...
<head>
    ...
    <title>Liste production Airbus A319</title>
</head>
...
<body>
    ...
    <section>
        <div class="container">
            <h1>Liste production Airbus A319</h1>
            <?php
            ...
            require_once '../daos/clientDAOa319.php';
            ...
            try {
                $query = "SELECT numero_serie_avion, modele_avion, nom_compagnie, date_premier_vol_avion, immatriculation_compagnie_avion, statut_avion FROM `avion` WHERE nom_avion = 'A319'";
