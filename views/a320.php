...
<head>
    ...
    <title>Liste production Airbus A320</title>
</head>
...
<body>
    ...
    <section>
        <div class="container">
            ...
            try {
                $query = "SELECT numero_serie_avion, modele_avion, nom_compagnie, date_premier_vol_avion, immatriculation_compagnie_avion, statut_avion FROM `avion` WHERE nom_avion = 'A320'";
